                    ...
                    Card(
                        Table(
                            ...
                            Tr(
                                ...
                                Select(
                                    *[
                                        Option(f"{station}", value=f"{station}")
        ...
        Body(
            ...
            Div(
                ...
                *[
                    Div(
                        Div(
                            P(f"เวลาออก: {train['departure']}", Class="col"),
                            P(f"เวลาถึง: {train['arrival']}", Class="col"),
                            P(f"ประเภท: {train['type']}", Class="col"),
                            P(f"ขบวนที่: {train['train_no']}", Class="col"),
                            A("เลือก", href=f"/select/{train['train_no']}", Class="btn"),
                            Class="card-row",
                        ),
                        Class="card",
                    )
            ...
            Div(
                *[
                    Div(
                        Div(
                            P(
                                f"{c['name']}: รถโบกี้ ชั้น {c['floor']} {c['type']} - {c['seat']}"
                            ),
                            P(f"ราคา: {c.get('price', c.get('price_lower', 0))} บาท"),
                            A(
                                "บันทึกไว้ใน Waiting List",
                                href=f"/waiting/{c['name']}",
...
def get():
    ...
    train_info = {
        "train_no": 13,
        "train_type": "ด่วนพิเศษ",
        "source": "สถานีกลางกรุงเทพอภิวัฒน์",
        "destination": "เชียงใหม่",
        "departure_time": "20:05",
        "arrival_time": "08:40",
        "date": "09 มีนาคม 2568",
        "carriage": "คันที่ 5 เขย.76",
        "carriage_type": "รถโบกี้ ชั้น 3 พัดลม",
        "passenger_type": "ผู้โดยสารทั่วไป",
        "seats": [
            {"seat_no": 1, "status": "available"},
            {"seat_no": 2, "status": "occupied"},
            {"seat_no": 3, "status": "available"},
            {"seat_no": 4, "status": "available"},
            {"seat_no": 5, "status": "occupied"},
            {"seat_no": 6, "status": "available"},
            {"seat_no": 7, "status": "available"},
            {"seat_no": 8, "status": "occupied"},
            {"seat_no": 9, "status": "available"},
            {"seat_no": 10, "status": "available"},
        ]
    }
