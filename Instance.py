...
def create_instance(control):
    ...
    route_bkk_to_chiangmai = Route(north, distance_bkk_to_chiangmai)
    route_bkk_to_ubon = Route(northeast_ubon, distance_bkk_to_ubon)
    route_bkk_to_nongkuy = Route(northeast_nongkuy, distance_bkk_to_nongkuy)
    route_bkk_to_hadyai = Route(south, distance_bkk_to_hadyai)
    ...
    m1 = Member("มนศักดิ์ มาโค", "totomove55@gmail.com", "member", "0653619287", "1234")
    m2 = Member("พัฒนพงศ ร่มเย็น","patta@mail.com","member","0894556552","123456")
